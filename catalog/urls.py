...
from .views import (index,
                    ...
                    UserPasswordResetView, UserPasswordResetConfirmView, presentation, page_header, features, navbars,
                    nav_tabs, pagination, inputs, forms, alerts, modals, typography, toggles, progress_bars, dropdowns,
                    buttons, breadcrumbs, badges, avatars, tooltips, TaskDetailView, ChangeTaskStatus, MyTaskView,
                    AllTasksIfAdminView, UpdateTasksView, DeleteTasksView, CreateTasksView,
                    )
...
urlpatterns = [
    ...
    path('change-task-status/<int:pk>/', ChangeTaskStatus.as_view(), name='change_task_status'),
