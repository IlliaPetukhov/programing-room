...
urlpatterns = [
    ...
    path("tasks-if-admin/", AllTasksIfAdminView.as_view(),
         name="tasks-if-admin"),
    path("update-task/<int:pk>/", UpdateTasksView.as_view(),
         name="update-task"),
    path("delete-task/<int:pk>/", DeleteTasksView.as_view(),
         name="delete-task"),
    path("create-task/", CreateTasksView.as_view(),
         name="create-task"),
]
