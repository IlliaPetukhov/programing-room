...
class Tasks(models.Model):
    ...
    level = models.ForeignKey(LevelOfDifficulty, on_delete=models.CASCADE,
                              null=False,
                              blank=False)
    programmer = models.ForeignKey(Programmer, on_delete=models.CASCADE, null=True, blank=True)
